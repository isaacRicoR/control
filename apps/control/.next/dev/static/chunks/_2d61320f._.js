...
"[project]/apps/control/app/(shell)/devices/list/DevicesListClient.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DevicesListClient() {
    ...
    const handleDepartmentChange = (department)=>setFilter("department", department);
    // ─── Data state ──────────────────────────────────────────────────────────
    ...
    // ─── Fetch ───────────────────────────────────────────────────────────────
    const fetchDevices = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].useCallback({
        "DevicesListClient.useCallback[fetchDevices]": async ()=>{
            try {
                const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$console$2f$core$2f$connector$2f$httpClient$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["request"])("/devices?limit=100");
                if (!response.ok) {
                ...
                const mapped = (response.data ?? []).map({
                    "DevicesListClient.useCallback[fetchDevices].mapped": (d)=>({
                            id: d.id,
                            nombre: d.nombre,
                            tipo: d.tipo,
                ...
                }["DevicesListClient.useCallback[fetchDevices].mapped"]);
                setRows(mapped);
            } catch (error) {
    ...
    }["DevicesListClient.useCallback[fetchDevices]"], [
        showToast
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "DevicesListClient.useEffect": ()=>{
            fetchDevices();
        }
    }["DevicesListClient.useEffect"], [
        fetchDevices
    ...
    if (("TURBOPACK compile-time value", "development") !== 'production' && debugState) {
        ...
        if (debugState === "empty") return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$console$2f$ui$2f$containers$2f$EmptyState$2f$EmptyState$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["EmptyState"], {
            ...
            description: "No hay dispositivos registrados (debug).",
            icon: "monitor"
        }, void 0, false, {
            fileName: "[project]/apps/control/app/(shell)/devices/list/DevicesListClient.tsx",
            lineNumber: 124,
    ...
    const deviceAvatarIconColor = theme === "dark" ? semantic.text.default : semantic.icon?.muted ?? semantic.text.muted;
    // ─── Columns ──────────────────────────────────────────────────────────────
    const columns = [
        {
            key: "nombre",
            ...
            filterable: true,
            filterValue: (row)=>`${row.nombre} ${row.tipo}`,
        ...
        },
        {
            ...
            header: "Usuario",
            filterable: true,
            filterValue: (row)=>row.usuario,
            cell: (row)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    style: {
                        color: row.usuario ? semantic.text.muted : semantic.text.disabled,
                        fontFamily: __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$console$2f$tokens$2f$typography$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["typography"].fontFamily.primary
                    },
                                    ...
                                    [
                                        {
                                            ...
                                            icon: "user",
                                            onClick: ()=>console.log("Reasignar", row.id)
                                        },
                                        {
                                            type: "item",
                                            label: "Enviar a mantenimiento",
                                            icon: "settings",
                                            onClick: ()=>console.log("Mantenimiento", row.id)
                                        }
                                    ],
                                    [
                                        {
                                            ...
                                            icon: "alert-circle",
                                            variant: "warning",
                                            onClick: ()=>console.log("Bloquear", row.id)
                                        },
                                        {
                                            type: "item",
                                            label: "Dar de baja",
                                            icon: "trash",
                                            variant: "danger",
                                            onClick: ()=>console.log("Dar de baja", row.id)
                                        }
                                    ]
                                ]
                            }, void 0, false, {
...
_s(DevicesListClient, "xEr37OhLQxY/hP1xQxITnw0HXgA=", false, function() {
    return [
...
_c = DevicesListClient;
var _c;
__turbopack_context__.k.register(_c, "DevicesListClient");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_2d61320f._.js.map