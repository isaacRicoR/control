...
"[project]/apps/control/app/(shell)/devices/list/DevicesListClient.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function DevicesListClient() {
    ...
    // ─── Fetch ───────────────────────────────────────────────────────────────
    const fetchDevices = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].useCallback(async ()=>{
        try {
            const response = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$console$2f$core$2f$connector$2f$httpClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["request"])("/devices?limit=100");
            if (!response.ok) {
...
//# sourceMappingURL=_daabbf6e._.js.map