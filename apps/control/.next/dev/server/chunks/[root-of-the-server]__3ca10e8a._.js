...
"[project]/apps/control/app/api/users/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const limit = !isNaN(parsedLimit) && parsedLimit >= 1 && parsedLimit <= 100 ? parsedLimit : parsedLimit > 100 ? 100 : 20;
        // Get paginated users from service layer
        const result = __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$services$2f$users$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listUsers"](page, limit);
        const totalPages = Math.ceil(result.total / limit);
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$http$2f$envelope$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["okResponse"])(result.items, {
            page,
            limit,
            total: result.total,
            totalPages,
...
async function POST(request) {
    try {
        ...
        if (!body.name || typeof body.name !== 'string' || body.name.trim() === '') {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$http$2f$envelope$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["badRequestResponse"])('El campo "name" es requerido y debe ser un string no vacío.', [
                {
                    field: 'name',
                    issue: 'required'
                }
        ...
        if (!body.email || typeof body.email !== 'string' || body.email.trim() === '') {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$http$2f$envelope$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["badRequestResponse"])('El campo "email" es requerido y debe ser un string no vacío.', [
                {
                    field: 'email',
                    issue: 'required'
                }
        ...
        const newUser = __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$services$2f$users$2e$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createUser"]({
            name: body.name,
            email: body.email,
        ...
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$http$2f$envelope$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createdResponse"])(newUser);
    } catch (error) {
        const message = error instanceof Error ? error.message : 'Error al procesar la solicitud';
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$http$2f$envelope$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["badRequestResponse"])(message);
    }
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__3ca10e8a._.js.map